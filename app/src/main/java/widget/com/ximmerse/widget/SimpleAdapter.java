...
// Source : http://grepcode.com/file/repository.grepcode.com/java/ext/com.google.android/android/4.4.4_r1/android/widget/SimpleAdapter.java?av=f
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (v != null) {
                ...
                if(mOnViewCreatedListener!=null){
                    mOnViewCreatedListener.onViewCreated(position,view);
                }
            }
        }
    }
